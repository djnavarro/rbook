...
More recently, @matejka2017 demonstated the ability to create drastically different datasets with the same correlation between X-Y as well as the same means and standard deviations.

```{r data_dino, fig.caption="Another way of visualising this is this gif. All graphs show data with the same means, standard deviations, and correlation", echo=FALSE}
knitr::include_graphics("./img/descriptives/data_dino.gif")
```
