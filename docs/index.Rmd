---
title: '<div class="jumbotron"><h1 class="title toc-ignore display-3" align="center">Learning Statistics with R</h1><p class="lead" align="center">by Danielle Navarro <a href="https://fosstodon.org/@djnavarro"><i class="fab fa-mastodon"></i></a></p></div>'
output:
  html_document:
    includes:
...
- **Chapter 5: Descriptive statistics.** Mean, median and mode. Range, interquartile range and standard deviations. Skew. Standard scores. Correlations. Tools for computing these things in R. Brief comments missing data.
...
<center>
---- &nbsp;&nbsp;
<a href="https://fosstodon.org/@djnavarro"><i class="fab fa-mastodon"></i></a> &nbsp;
<a href="https://djnavarro.net"><i class="fas fa-home"></i></a> &nbsp;
<a href="https://github.com/djnavarro"><i class="fab fa-github"></i></a> &nbsp;
<a href="mailto:djnavarro@protonmail.com"><i class="fas fa-paper-plane"></i></a>
&nbsp;&nbsp; ----
</center>
<br>
<br>
