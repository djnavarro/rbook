---
title: '<div class="jumbotron"><h1 class="title toc-ignore display-3" align="center">Learning Statistics with R</h1><p class="lead" align="center">Danielle Navarro</p></div>'
output:
  html_document:
    includes:
...
The book is also associated with the `lsr` package, available on CRAN and github. The package is probably okay for many introductory teaching purposes, but I should note that this package isn't being actively updated, and I would strongly recommend taking care if you are thinking of using it in real world data analysis. (There's one known bug that I've been meaning to fix: the `etaSquared` function returns absurd results for unbalanced designs)
...
- Matt Crump's lovely book-in-progress, <a href="https://crumplab.github.io/statistics/">Answering questions with data</a>, uses some content from LSR
...
- My own adaptation is a work in progress, [R for Psychological Science](https://compcogscisydney.org/psyr/)
