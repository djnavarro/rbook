...
knitr::include_graphics(file.path(projecthome, "img", "estimation", "srs1.pdf"))
```
...
knitr::include_graphics(file.path(projecthome, "img/estimation/brs.pdf"))

```

```{r srs2, fig.cap="Simple random sampling *with* replacement from a finite population", echo=FALSE}
knitr::include_graphics(file.path(projecthome, "img/estimation/srs2.pdf"))
...
knitr::include_graphics(file.path(projecthome, "img/estimation/samplingDist4.pdf"))
...
knitr::include_graphics(file.path(projecthome, "img/estimation/samplingDistMax.pdf"))
...
knitr::include_graphics(file.path(projecthome, "img/estimation/samplingDistSampleSD.pdf"))
...
knitr::include_graphics(file.path(projecthome, "img/estimation/biasMean.pdf"))
knitr::include_graphics(file.path(projecthome, "img/estimation/biasSD.pdf"))
```
...
knitr::include_graphics(file.path(projecthome, "img/estimation/confIntReplicated.pdf"))
