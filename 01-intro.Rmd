...
kable(simpson, col.names = c("Department","Applicants", "Percent Admitted", "Applicants", "Percent admitted"), align="c", caption = "Admission figures for the six largest departments by gender") %>%
  kable_styling(full_width = F) %>%
  add_header_above(c(" ", "Males" = 2, "Female" = 2))
```
...
source("./scripts/ekothe_plotberkeley.R")
