...
```{r fig.cap="If you've typed the name of a function already along with the left parenthesis and then hit the \"tab\" key, RStudio brings up a different window to the one shown in Figure \\@ref(fig:RStudiotab). This one lists all the arguments to the function on the left, and information about each argument on the right.", echo=FALSE}
...
```{r fig.cap="The history panel is located in the top right hand side of the RStudio window. Click on the word \"History\" and it displays this panel.", echo=FALSE}
