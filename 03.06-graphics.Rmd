...
```{r firstplot, fig.cap="Our first plot", echo=FALSE}
Fibonacci <- c( 1,1,2,3,5,8,13)
plot(Fibonacci)
```
...
```{r secondplot, fig.cap="How to add your own title, subtitle, x-axis label and y-axis label to the plot.", echo=FALSE}
plot( x = Fibonacci,
	           main = "You specify title using the 'main' argument",
	           sub = "The subtitle appears here! (Use the 'sub' argument for this)",
	           xlab = "The x-axis label is 'xlab'",
...
+ )
```
```{r thirdplot, fig.cap="How to customise the appearance of the titles and labels.", echo=FALSE}
plot( x = Fibonacci,                           # the data to plot
          main = "The first 7 Fibonacci numbers",  # the title
          xlab = "Position in the sequence",       # x-axis label
...
knitr::include_graphics("./rbook-master/img/graphics2/simpleplot.png")

```

### Changing other features of the plot

```{r pch, echo=FALSE, fig.cap="Changing the line and plotted characters of the plot."}
knitr::include_graphics("./rbook-master/img/graphics2/pchlty.png")
...
```{r hist1a, fig.cap="The default histogram that R produces"}
...
```{r boxplot1, fig.cap="A basic boxplot (panel a), plus the same plot with annotations added to explain what aspect of the data set each part of the boxplot corresponds to (panel b).", echo=FALSE}
knitr::include_graphics("./rbook-master/img/graphics2/boxplot1.png")
...
afl.margins_out<-afl.margins
afl.margins_out[137]<-333
boxplot( x = afl.margins_out,           # the data
...
```{r scatter, fig.cap="{Two different scatterplots: (a) the default scatterplot that R produces, (b) one that makes use of several options for fancier display.", echo=FALSE}
knitr::include_graphics("./rbook-master/img/graphics2/scatter1.png")
...
```{r scattera, fig.cap="the default scatterplot that R produces", echo=FALSE} 
...
```{r bar1d, fig.cap="we fix this by expanding the margin at the bottom, and add several other customisations to make the chart a bit nicer", echo=FALSE}
