...
\caption{The `booksales2.csv` data file. It contains more or less the same data as the original `booksales.csv` data file, but has a lot of very quirky features.}
{#fig:booksales2csv}
\HR
\end{center}
\end{figure} 
...
- Section@refsec:freqtables. Tabulating data.
- Section@refsec:transform. Transforming or recoding a variable.
- Section@refsec:mathfunc. Some useful mathematical functions.
- Section@refsec:subset. Extracting a subset of a vector.
- Section@refsec:subsetdataframe. Extracting a subset of a data frame.
- Section@refsec:sort. Sorting, flipping or merging data sets.
- Section@refsec:reshape. Reshaping a data frame.
- Section@refsec:textprocessing. Manipulating text.
- Section@refsec:importing. Opening data from different file types.
- Section@refsec:coercion. Coercing data from one type to another.
- Section@refsec:datastructures. Other important data types.
- Section@refsec:miscdatahandling. Miscellaneous topics.
